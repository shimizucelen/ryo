...
(function () {
    ...
    var countDownDate = new Date("Dec 12, 2019 00:00:00").getTime();
    ...
    var x = setInterval(function () {
        ...
        // Display the result in an element with id="demo"
        document.getElementById("year").innerHTML = year + " <small>歳</small>";
        document.getElementById("month").innerHTML = month + " <small>ヶ月</small>";
